...
#### Version1. Lambda를 이용한 start, stop  
매 시간 마다 체크해줘야 한다.      
...
![scouter](/assets/it/cloud/ec2schedule/createRule.png){: width="300" height="217"}  

위의 이미지와 같이 Cron expression 0 10 ? * MON-SUN * 을 통해 월요일-금요일 매 10:00:00GMT (18:00:00 KMT) 시간에 StopEC2Instance 스케줄이 돌도록 설정한다.  

<br><br>

![scouter](/assets/it/cloud/ec2schedule/cloudEvents.png){: width="300" height="217"}   
