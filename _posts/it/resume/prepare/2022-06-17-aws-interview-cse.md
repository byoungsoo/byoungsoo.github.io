...
0. 자기소개
   자기소개 하도록 하겠습니다. 저는 2015년도에 LG CNS에 처음 입사하여 4년간 LG전자 GERP생산팀에서 INV/IWMS 모듈을 맡아 ERP개발 및 유지/보수 업무를 수행했습니다.
   이 후에는 Cloud 아키텍처팀으로 이동해서 SWA로서 업무를 수행했습니다. 
   대표적인 프로젝트로는 대한항공 Migration 프로젝트, LG화학 Public Cloud전환 프로젝트, 한화생면 SFA MSP 프로젝트, KB카드 마이데이터 프로젝트 등의 업물를 수행했습니다. 
   해당 프로젝트 들에서는 WEB/WAS관련된 미들웨어 업무, CI/CD, Telemetry, ECS, EKS등의 부분을 맡아 시스템의 환경구축을 담당했습니다. 
   작년 10월에는 카카오엔터프라이즈라는 회사로 이동하여 Openstack 기반의 공공클라우드 개발을 진행하고 있습니다. 
...
6. 고객에 집착했던 경험 
   1) 한 번은 KB카드 마이데이터 프로젝트 진행 중 어플리케이션에서 마이데이터 제공시 오류가 발생한 적이 있었습니다. 
