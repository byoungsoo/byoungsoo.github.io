...
eksctl create iamidentitymapping --cluster bys-dev-eks-v124 --region=ap-northeast-2 --arn arn:aws:iam::558846430793:role/AdminDevAccountRole --group system:masters --username AdminDev
eksctl create iamidentitymapping --cluster bys-dev-eks-v125 --region=ap-northeast-2 --arn arn:aws:iam::558846430793:role/AdminDevAccountRole --group system:masters --username AdminDev
eksctl create iamidentitymapping --cluster bys-dev-eks-v126 --region=ap-northeast-2 --arn arn:aws:iam::558846430793:role/AdminDevAccountRole --group system:masters --username AdminDev
eksctl create iamidentitymapping --cluster bys-dev-eks-v127 --region=ap-northeast-2 --arn arn:aws:iam::558846430793:role/AdminDevAccountRole --group system:masters --username AdminDev
```
