...
public class CnfCdIsuCmd extends ExtAbstractCommand {

	@Override
	public void execute() throws Exception {

		LLog.debug.println("CnfCdIsuCmd !!!!!!!!!!!!!!!");
		...
		LData result = (LData) BizCommand.execute("com.kbcard.ubd.pbi.ctf.idv.IdvCtfPbc", "IdvCtfCnfCdRsp", data);
