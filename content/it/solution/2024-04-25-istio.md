...
description: "Istio Service Mesh의 아키텍처와 Kubernetes 환경에서의 설치 및 설정 방법. 컨트롤 플레인, 데이터 플레인 구조, 트래픽 관리, mTLS 보안, 관찰 가능성 설정을 실습 예제와 함께 설명합니다."
---
...
<img src="/assets/it/cloud/eks/service-mesh/istio-architecture001.png" alt="istio-architecture001.png" style="width: 70%; height: auto;">  
...
Envoy 프록시는 사이드카 패턴으로 배포되며 논리적으로 Envoy의 아래의 다양한 built-in 기능으로 서비스를 논리적으로 보강한다.  
...
#### 2.3. [Kiali dashboard](https://istio.io/latest/docs/tasks/observability/kiali/)
