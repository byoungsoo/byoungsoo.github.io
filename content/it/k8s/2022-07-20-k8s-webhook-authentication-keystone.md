---
slug: k8s-webhook-authentication-keystone
author: Bys
categories:
- k8s
category: k8s
...
- **k8s-keystone-auth**  
Kubernetes webhook 인증과 인가를 Openstack의 Keystone과 연동하기 위한 방법이다. 
...
[<img src="/assets/it/k8s/k8s/kubeadm_auth_webhook006.png" alt="kubeadm_auth_webhook006" style="width: 80%; height: auto;">](/assets/it/k8s/k8s/kubeadm_auth_webhook006.png)  
