---
slug: k8s-webhook-authentication
author: Bys
categories:
- k8s
category: k8s
...
- Flow  
[<img src="/assets/it/k8s/k8s/kubeadm_auth_webhook001.png" alt="kubeadm_auth_webhook001" style="width: 80%; height: auto;">](/assets/it/k8s/k8s/kubeadm_auth_webhook001.png)  
...
[<img src="/assets/it/k8s/k8s/kubeadm_auth_webhook004.png" alt="kubeadm_auth_webhook004" style="width: 50%; height: auto;">](/assets/it/k8s/k8s/kubeadm_auth_webhook004.png)  
...
[<img src="/assets/it/k8s/k8s/kubeadm_auth_webhook005.png" alt="kubeadm_auth_webhook005" style="width: 80%; height: auto;">](/assets/it/k8s/k8s/kubeadm_auth_webhook005.png)  
...
[<img src="/assets/it/k8s/k8s/kubeadm_auth_webhook003.png" alt="kubeadm_auth_webhook003" style="width: 50%; height: auto;">](/assets/it/k8s/k8s/kubeadm_auth_webhook003.png)  
