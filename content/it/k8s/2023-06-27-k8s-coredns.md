...
description: "Kubernetes CoreDNS의 동작 원리와 설정 방법. 클러스터 내 DNS 쿼리 처리 과정, Corefile 설정, EKS에서 CoreDNS 커스터마이징, DNS 트러블슈팅 방법을 설명합니다."
---
...
<img src="/assets/it/cloud/eks/coredns.png" alt="coredns" style="width: 70%; height: auto;">
