...
[<img src="/assets/it/k8s/k8s/k8s-workflow-deployment.png" alt="k8s-workflow-deployment" style="width: 80%; height: auto;">](/assets/it/k8s/k8s/k8s-workflow-deployment.png)  
