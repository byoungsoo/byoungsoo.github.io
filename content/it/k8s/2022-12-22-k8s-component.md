...
<img src="/assets/it/k8s/k8s/kubernetes-component001.png" alt="kubernetes-component001" style="width: 100%; height: auto;">  

다음은 Kubernetes를 설치한 이 후에 가장 기본적인 상태를 조회한 것이다.  
Pod를 보면 EKS에서는 볼 수 없었던 control plane 구성 요소인 kube-apiserver, kube-controller-manager, kube-scheduler, etcd 컴포넌트를 볼 수 있다.  
...
cloud-controller-manager 또한 kube-controller-manager와 마찬가지로 논리적으로 여러 독립적인 컨트롤 루프를 single binary로 합쳐 단일 프로세스로 동작한다. 
