...
1. Amazon Linux 3 기반 Launch Template을 생성
    ...
    install_package java-11-amazon-corretto.x86_64
...
Codedeploy agent는 폴링 방식을 통해 Codedeploy 서비스를 확인하다 배포가 있을 경우, [In-place deployments](https://docs.aws.amazon.com/codedeploy/latest/userguide/reference-appspec-file-structure-hooks.html#:~:text=in%20this%20diagram.-,In%2Dplace%20deployments,-In%20an%20in) 라이프사이클 훅에 따라 동작한다.  
    ...
    <img src="/assets/it/cloud/codeseries/ec2_in_place_lifecycle.png" alt="ec2_in_place_lifecycle" style="width: 40%; height: auto;">  
...
<img src="/assets/it/cloud/codeseries/asg_lifecycle_1.png" alt="asg_lifecycle_1" style="width: 60%; height: auto;">  
...
<img src="/assets/it/cloud/codeseries/asg_lifecycle.png" alt="asg_lifecycle" style="width: 60%; height: auto;">  
...
Codedeploy agent는 폴링 방식을 통해 Codedeploy 서비스를 확인하다 배포가 있을 경우, [In-place deployments](https://docs.aws.amazon.com/codedeploy/latest/userguide/reference-appspec-file-structure-hooks.html#:~:text=in%20this%20diagram.-,In%2Dplace%20deployments,-In%20an%20in) 라이프사이클 훅에 따라 동작한다.  
    ...
    <img src="/assets/it/cloud/codeseries/ec2_blue_green_lifecycle.png" alt="ec2_blue_green_lifecycle" style="width: 40%; height: auto;">  
