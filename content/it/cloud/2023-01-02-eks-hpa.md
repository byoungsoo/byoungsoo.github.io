...
description: "EKS에서 HPA(Horizontal Pod Autoscaler)와 metrics-server를 활용한 파드 자동 확장 설정. CPU/메모리 기반 스케일링 정책 설정과 동작 원리를 실습 예제와 함께 설명합니다."
---
...
<img src="/assets/it/cloud/eks/metric-server-architecture.png" alt="metric-server-architecture" style="width: 70%; height: auto;">

<img src="/assets/it/cloud/eks/hpa001.png" alt="hpa001" style="width: 95%; height: auto;">  
